...
//
// V6 spacing vocabulary — hand-tuned so cards NEVER overlap at any size.
// Row bands: GK y4 · back line y18-21 · holding y38-44 · midfield y48-56 ·
// attacking mid y62-68 · wide forwards y74-80 · strikers y86-88. The GK sits
// deep (y4) to clear the centre-backs; centre-backs are spread wide; front
// lines and double pivots are pushed apart. Paired with the pitch projection
// (8 + x·0.84 across, 5 + (100−y)·0.84 up) every neighbour keeps clear air.
export const FORMATIONS: Formation[] = [
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CM", x: 68, y: 52 }, { pos: "CM", x: 50, y: 48 }, { pos: "CM", x: 32, y: 52 },
      { pos: "RW", x: 83, y: 78 }, { pos: "ST", x: 50, y: 88 }, { pos: "LW", x: 17, y: 78 },
    ],
  },
  {
    name: "4-3-3 (2)",
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CM", x: 70, y: 54 }, { pos: "CDM", x: 50, y: 40 }, { pos: "CM", x: 30, y: 54 },
      { pos: "RW", x: 83, y: 78 }, { pos: "ST", x: 50, y: 88 }, { pos: "LW", x: 17, y: 78 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CDM", x: 63, y: 40 }, { pos: "CDM", x: 37, y: 40 }, { pos: "CM", x: 50, y: 56 },
      { pos: "RW", x: 83, y: 78 }, { pos: "ST", x: 50, y: 88 }, { pos: "LW", x: 17, y: 78 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CDM", x: 64, y: 40 }, { pos: "CDM", x: 36, y: 40 },
      { pos: "RM", x: 84, y: 60 }, { pos: "CAM", x: 50, y: 63 }, { pos: "LM", x: 16, y: 60 },
      { pos: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "RM", x: 85, y: 54 }, { pos: "CM", x: 62, y: 50 }, { pos: "CM", x: 38, y: 50 }, { pos: "LM", x: 15, y: 54 },
      { pos: "ST", x: 62, y: 86 }, { pos: "ST", x: 38, y: 86 },
    ],
  },
  {
    name: "4-5-1",
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "RM", x: 87, y: 56 }, { pos: "CM", x: 65, y: 50 }, { pos: "CAM", x: 50, y: 62 }, { pos: "CM", x: 35, y: 50 }, { pos: "LM", x: 13, y: 56 },
      { pos: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      ...
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CDM", x: 50, y: 38 },
      { pos: "CM", x: 72, y: 54 }, { pos: "CM", x: 28, y: 54 },
      { pos: "CAM", x: 50, y: 68 },
      { pos: "ST", x: 62, y: 88 }, { pos: "ST", x: 38, y: 88 },
    ],
  },
  {
    name: "4-1-4-1",
    ...
    slots: [
      ...
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CDM", x: 50, y: 40 },
      { pos: "RM", x: 85, y: 58 }, { pos: "CM", x: 62, y: 54 }, { pos: "CM", x: 38, y: 54 }, { pos: "LM", x: 15, y: 58 },
      { pos: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CDM", x: 63, y: 41 }, { pos: "CDM", x: 37, y: 41 },
      { pos: "CAM", x: 74, y: 63 }, { pos: "CAM", x: 26, y: 63 },
      { pos: "ST", x: 62, y: 88 }, { pos: "ST", x: 38, y: 88 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "CB", x: 72, y: 21 }, { pos: "CB", x: 50, y: 19 }, { pos: "CB", x: 28, y: 21 },
      { pos: "RWB", x: 92, y: 46 }, { pos: "LWB", x: 8, y: 46 },
      { pos: "CM", x: 66, y: 52 }, { pos: "CDM", x: 50, y: 40 }, { pos: "CM", x: 34, y: 52 },
      { pos: "ST", x: 62, y: 86 }, { pos: "ST", x: 38, y: 86 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "CB", x: 72, y: 21 }, { pos: "CB", x: 50, y: 19 }, { pos: "CB", x: 28, y: 21 },
      { pos: "RM", x: 87, y: 52 }, { pos: "CM", x: 63, y: 46 }, { pos: "CM", x: 37, y: 46 }, { pos: "LM", x: 13, y: 52 },
      { pos: "RW", x: 80, y: 80 }, { pos: "ST", x: 50, y: 88 }, { pos: "LW", x: 20, y: 80 },
    ],
  },
  {
    name: "3-4-2-1",
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "CB", x: 72, y: 21 }, { pos: "CB", x: 50, y: 19 }, { pos: "CB", x: 28, y: 21 },
      { pos: "RM", x: 87, y: 50 }, { pos: "CM", x: 63, y: 44 }, { pos: "CM", x: 37, y: 44 }, { pos: "LM", x: 13, y: 50 },
  ...
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RWB", x: 90, y: 34 }, { pos: "CB", x: 72, y: 20 }, { pos: "CB", x: 50, y: 18 }, { pos: "CB", x: 28, y: 20 }, { pos: "LWB", x: 10, y: 34 },
      { pos: "CM", x: 66, y: 54 }, { pos: "CDM", x: 50, y: 44 }, { pos: "CM", x: 34, y: 54 },
      { pos: "ST", x: 62, y: 86 }, { pos: "ST", x: 38, y: 86 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RWB", x: 90, y: 34 }, { pos: "CB", x: 72, y: 20 }, { pos: "CB", x: 50, y: 18 }, { pos: "CB", x: 28, y: 20 }, { pos: "LWB", x: 10, y: 34 },
      { pos: "CM", x: 63, y: 48 }, { pos: "CM", x: 37, y: 48 },
      { pos: "CAM", x: 50, y: 66 },
      { pos: "ST", x: 62, y: 88 }, { pos: "ST", x: 38, y: 88 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RWB", x: 90, y: 34 }, { pos: "CB", x: 72, y: 20 }, { pos: "CB", x: 50, y: 18 }, { pos: "CB", x: 28, y: 20 }, { pos: "LWB", x: 10, y: 34 },
      { pos: "RM", x: 83, y: 58 }, { pos: "CM", x: 60, y: 52 }, { pos: "CM", x: 40, y: 52 }, { pos: "LM", x: 17, y: 58 },
      { pos: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "CDM", x: 50, y: 38 }, { pos: "CM", x: 70, y: 52 }, { pos: "CM", x: 30, y: 52 },
      { pos: "CAM", x: 66, y: 68 }, { pos: "CAM", x: 34, y: 68 },
      { pos: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      { pos: "GK", x: 50, y: 2 },
      { pos: "RB", x: 84, y: 21 }, { pos: "CB", x: 61, y: 20 }, { pos: "CB", x: 39, y: 20 }, { pos: "LB", x: 16, y: 21 },
      { pos: "RM", x: 85, y: 52 }, { pos: "CM", x: 62, y: 48 }, { pos: "CM", x: 38, y: 48 }, { pos: "LM", x: 15, y: 52 },
      { pos: "CF", x: 50, y: 68 },
      { pos: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      ...
      { pos: "RW", x: 88, y: 74 }, { pos: "LW", x: 12, y: 74 },
      { pos: "ST", x: 63, y: 88 }, { pos: "ST", x: 37, y: 88 },
    ],
  },
];

...
const DICT: Record<string, Entry> = {
  ...
  "home.tile.new": { en: "New", es: "Nuevo" },
  "home.tile.career.kicker": { en: "Player Career", es: "Carrera del Jugador" },
  "home.tile.career.tag": { en: "Academy → Legend", es: "Cantera → Leyenda" },
  "home.tile.cl.kicker": { en: "Club · Europe", es: "Clubes · Europa" },
  "home.tile.cl.tag": { en: "Club legends, 7 decades", es: "Leyendas de club, 7 décadas" },
  "home.tile.euro.kicker": { en: "Nations · UEFA", es: "Selecciones · UEFA" },
  "home.tile.euro.tag": { en: "Nations of Europe", es: "Selecciones de Europa" },
  "home.tile.copa.kicker": { en: "Nations · CONMEBOL", es: "Selecciones · CONMEBOL" },
  "home.tile.copa.tag": { en: "South American giants", es: "Gigantes de Sudamérica" },
  "home.tile.daily.kicker": { en: "One draft for all", es: "Un sorteo para todos" },
  "home.more.history": { en: "Match History", es: "Historial" },
  "home.more.profile": { en: "Your Profile", es: "Tu Perfil" },
